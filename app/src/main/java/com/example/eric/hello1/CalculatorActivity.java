...
public class CalculatorActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonCal0).setOnClickListener(this);
        findViewById(R.id.buttonCal1).setOnClickListener(this);
        findViewById(R.id.buttonCal2).setOnClickListener(this);
        findViewById(R.id.buttonCal3).setOnClickListener(this);
        findViewById(R.id.buttonCal4).setOnClickListener(this);
        findViewById(R.id.buttonCal5).setOnClickListener(this);
        findViewById(R.id.buttonCal6).setOnClickListener(this);
        findViewById(R.id.buttonCal7).setOnClickListener(this);
        findViewById(R.id.buttonCal8).setOnClickListener(this);
        findViewById(R.id.buttonCal9).setOnClickListener(this);
